...
const Home = () => {
  ...
  return ( 
    <div className="w-full h-screen text-center pt-44" style={{ background: "linear-gradient(143.6deg, rgba(192, 132, 252, 0) 20.79%, rgba(232, 121, 249, 0.26) 40.92%, rgba(204, 171, 238, 0) 70.35%)" }}>
      ...
      <div className="mt-10 w-1/4 my-0 mx-auto bg-white h-12 rounded-3xl border-[1.2px] border-gray-300 focus-within:border-purple-600 flex justify-between py-1 pr-1 items-center">
        <div>
